...
namespace InstantLoot
{
	...
	{
		public static ConfigEntry<string> activateInstantLootKey;

		public static string activateInstantLootDisplayName;
		...
		public static void BindConfigSettings()
		{
			...
			activateInstantLootKey = ((BaseUnityPlugin)InstantLoot.instance).Config.Bind<string>("InstantLoot", "InstantLootKey", "<Keyboard>/l", "Activate instant loot keybind.");
			activateInstantLootDisplayName = GetDisplayName(activateInstantLootKey.Value);
			currentConfigEntries.Add(((ConfigEntryBase)activateInstantLootKey).Definition.Key, (ConfigEntryBase)(object)activateInstantLootKey);
		...
		public static void TryRemoveOldConfigSettings()
		{
			...
			try
			{
				...
				ConfigFile config = ((BaseUnityPlugin)InstantLoot.instance).Config;
